...
public:
    ...
    std::vector<AOUParticle> particles; //all the particles in the system
    ...
    NeighborGrid<AOUParticle, 2> *grid;
    ...
    arma::vec get_com();
    double get_energy();
    double get_energy_between(AOUParticle &p1, AOUParticle &p2);
    ...
    arma::vec get_force(AOUParticle &p1);
    arma::vec get_force_from(AOUParticle &p1, AOUParticle &p2);
    arma::vec get_force_neighbor_grid(AOUParticle &p);
    ...
    arma::vec get_disp_vec(AOUParticle &p1, AOUParticle &p2);
    double get_dist(AOUParticle &p1, AOUParticle &p2);
    Observer get_obs();
